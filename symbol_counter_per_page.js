const fs = require('fs');
const SYMBOLS_COUNTING_PER_PAGE = 80 * 20;
...
function getPage(book, pageNumber) {
    console.log(book.slice(SYMBOLS_COUNTING_PER_PAGE * (pageNumber - 1), SYMBOLS_COUNTING_PER_PAGE * pageNumber))
//    return // page text
}


const pagesCount = countPages(data.length, SYMBOLS_COUNTING_PER_PAGE)
